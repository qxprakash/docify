//! docif provides a simple set of rust macros, namely [`#[docif::export]`](`export`) and
//! [`docif::embed!`](`embed`), that allow you to dynamically embed tests and examples at
...
//!
//! The intent behind docif is to allow you to showcase your best examples and tests directly
...
//! ## General Usage
//!
//! Using `docif` is simple. First mark the tests/examples/items that you wish to embed with
//! `#[docif::export]`, such as the following:
//!
//! ```
//! #[docif::export]
//! fn some_example() {
...
//! ```
//!
//! You can then embed this item directly in doc comments using the `docif::embed` macro:
//!
//! ```
...
//! #[doc = docif::embed!("examples/samples.rs", some_example)]
...
//! comments that contain regular [`docif::embed!`](`macro@embed`) calls. See
...
//! the contents of `.README.docif.md`.
#![no_std]

pub use docif_macros::*;
pub use docif_macros::set_git_fallback;
